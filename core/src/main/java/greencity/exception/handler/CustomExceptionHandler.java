...
public class CustomExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    /**
     * Method interceptor exception {@link AccessIsDeniedException}.
     *
     * @param ex      Exception witch should be intercepted
     * @param request contain detail about occur exception
     * @return ResponseEntity witch contain http status and body with message of
    ...
    public ResponseEntity<ProblemDetail> handleAccessIsDeniedException(AccessIsDeniedException ex, WebRequest request) {
        return ResponseEntity.status(HttpStatus.FORBIDDEN).body(getProblemDetail(
                HttpStatus.FORBIDDEN,
                URI.create("about:blank"),
                "Access is denied!",
                URI.create(((jakarta.servlet.http.HttpServletRequest) request).getRequestURI()),
